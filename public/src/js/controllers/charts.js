...
angular.module('insight.charts').controller('ChartsController',
  function($scope, $routeParams, StatisticsBalanceIntervals, StatisticsByDaysSupply, StatisticsRicherThan, MarketsInfo, getSocket, $q, StatisticChart) {
    var self = this;
    ...
    $scope.$on('chart-create', function (evt, chart) {
      if (chart.chart.canvas.id === 'line') {
        statisticChart.changeCharColor(chart);
        chart.update();
      }
    });
